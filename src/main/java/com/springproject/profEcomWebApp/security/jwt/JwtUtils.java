package com.springproject.profEcomWebApp.security.jwt;
...
public class JwtUtils {
    ...
    public String getJWTFromCookies(HttpServletRequest httpServletRequest){
        Cookie cookie = WebUtils.getCookie(httpServletRequest, jwtcookieName);
        if (cookie!=null) {
    ...
    public ResponseCookie getCookieWithoutJwtToken(){
